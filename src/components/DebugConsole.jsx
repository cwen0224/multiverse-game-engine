...
export default function DebugConsole({
  ...
  return (
    <aside className="fixed right-4 top-4 z-40 w-[360px] max-w-[calc(100vw-1rem)] rounded-xl border border-slate-200/20 bg-slate-950/75 shadow-2xl backdrop-blur-md">
